...
it("should create an empty order with valid CPF", () => {
...
it("should not create an order if invalid CPF", () => {
	const cpf = "111.111.111-11";
	expect(() => new Order(cpf)).toThrowError("Invalid CPF");
});

it("should create order an three items with valid CPF", () => {
	const cpf = "152.726.480-72";
	const order = new Order(cpf);
...
it("should create order an three items with discount coupon", () => {
	const cpf = "152.726.480-72";
	const order = new Order(cpf);
	order.addItem(new Item(1, "Música", "CD", 30), 3);
	order.addItem(new Item(2, "Video", "DVD", 50), 1);
...
it("should create order an three items with expired discount coupon", () => {
	const cpf = "152.726.480-72";
...
it("should create order an three items with calculate items freight if strategy default", () => {
	const cpf = "152.726.480-72";
	const order = new Order(cpf, new Date("2021-12-11"));
	order.addItem(
...
it("should create order an three items with calculate items freight if strategy fixed", () => {
	const cpf = "152.726.480-72";
...
it("should create order with code", () => {
	const cpf = "152.726.480-72";
	const order = new Order(
		cpf,
		new Date("2021-12-11"),
